var AnalyticsEventsMaster = kendo.Class.extend({
    ...
    _initializeView: function () {
        ...
        if (actionName == "editAnalyticsEvent") {
            var id = this._getParameterByName("analyticsEventId");
            that.get_form().show(id);
        }
        else if (actionName == "newAnalyticsEvent") {
            that.get_form().show();
        }
    },
        ...
        $(this._masterElements.sortingDropDownList).kendoDropDownList({
            ...
            change: function (e) {
                ...
                if (e.sender.dataItem().value == "custom") {
                    $(that._masterElements.customSortingAnalyticsEventPropertiesDropDownList).kendoDropDownList({
                        dataTextField: "Name",
                        dataValueField: "Name",
                        dataSource: that.get_analyticsEventPropertiesDataSource()
                    });
                    that.set_customSortingAnalyticsEventPropertiesDropDownList($(that._masterElements.customSortingAnalyticsEventPropertiesDropDownList).data("kendoDropDownList"));
    ...
    _initializeCustomSortingDialog: function (dialogSettings) {
        ...
        this.set_analyticsEventPropertiesDataSource(propertiesDataSource);
        ...
        $(this._masterElements.saveCustomSortingButton).click(function () {
            var selectedProperty = that.get_customSortingAnalyticsEventPropertiesDropDownList().value();
        ...
        if ($(me._masterElements.batchDeleteButton).is('.sfDisabledLinkBtn')) {
            ...
            $(me._masterElements.batchDeleteButton).on('click', function () {
                ...
                if (checkedTextBoxes.length == 1) {
                    ...
                    $(me._masterElements.batchDeleteAnalyticsEventCountLabel).text(checkedTextBoxes.length);
    ...
    get_analyticsEventPropertiesDataSource: function () {
        return this._analyticsEventPropertiesDataSource;
    },
    set_analyticsEventPropertiesDataSource: function (dataSource) {
        this._analyticsEventPropertiesDataSource = dataSource;
    },

    get_customSortingAnalyticsEventPropertiesDropDownList: function () {
        return this._customSortingAnalyticsEventPropertiesDropDownList;
    },
    set_customSortingAnalyticsEventPropertiesDropDownList: function (dropDownList) {
        this._customSortingAnalyticsEventPropertiesDropDownList = dropDownList;
    },
    ...
    _masterElements: {
        masterGrid: "#analyticsEventsGrid",
        pagesWrapper: "#pagesWrapper",
        masterRowTemplate: "#analyticsEventsRowTemplate",
        decisionScreen: "#analyticsEventsDecisionScreen",
        checkAllCheckbox: "#checkAllCheckbox",
        deleteConfirmationDialog: "#deleteAnalyticsEventConfirmationDialog",
        confirmDeleteButton: "#confirmAnalyticsEventDeleteButton",
        cancelDeleteButton: "#cancelDeleteAnalyticsEventButton",
        batchDeleteButton: "#deleteUserAnalyticsEvents",
        batchDeleteConfirmationDialog: "#batchDeleteAnalyticsEventConfirmationDialog",
        batchDeleteAnalyticsEventCountLabel: "#batchDeleteAnalyticsEventCountLabel",
        confirmBatchDeleteButton: "#confirmAnalyticsEventBatchDeleteButton",
        cancelBatchDeleteButton: "#cancelBatchDeleteAnalyticsEventButton",
        sortingDropDownList: "#sortingDropDownList",
        customSortingDialog: "#analyticsEventCustomSortingDialog",
        customSortingAnalyticsEventPropertiesDropDownList: "#customSortingAnalyticsEventPropertiesDropDownList",
    ...
    _analyticsEventPropertiesDataSource: null,
    _customSortingAnalyticsEventPropertiesDropDownList: null,
